      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
            Lorem ipsum dolor sit amet hhjkj gfvc bhjm fgh.
          </h1>
          ...
          <p className="text-gray-500 font-medium">
            ...
            corporis eum debitis, incidunt ut exercitationem animi! Harum,
            eligendi dolore, voluptatum, doloremque ullam totam expedita unde
            nulla mollitia explicabo dolorum!
          </p>
        </div>
